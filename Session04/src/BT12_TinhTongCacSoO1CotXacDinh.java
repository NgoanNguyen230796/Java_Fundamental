...
public class BT12_TinhTongCacSoO1CotXacDinh {
    public static void main(String[] args) {
        ...
        System.out.printf("\n");
        System.out.println("Nhập thứ tự của cột mà bạn muốn tính tổng ở cột đó");
        int colNumber = Integer.parseInt(sc.nextLine());
        System.out.print("Tổng số phần tử trong cột " + colNumber + " là :");

        int sumCol = 0;
        for (int i = 0; i < arrInt.length; i++) {
            sumCol += arrInt[i][colNumber];
        }
