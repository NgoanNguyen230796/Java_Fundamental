...
public class ShopManagement {
    ...
    public static void main(String[] args) {
        do {
            ...
            do {
                try{
                    int choiceCategories = Integer.parseInt(sc.nextLine());
                    if(choiceCategories>0){
                        ...
                        System.err.println("Lựa chọn các mục trong SHOP MANAGEMENT phải là số nguyên lớn hơn 0,vui lòng nhập lại");
                    }
            ...
            do {
                try {
                    ...
                    if(choiceCatalog>0){
                        ...
                        System.err.println("Lựa chọn các mục trong CATALOG MANAGEMENT phải là số nguyên lớn hơn 0,vui lòng nhập lại");
                    }
                } catch (NumberFormatException ex) {
                                ...
                                do {
                                    try{
                                        ...
                                        if(number>0){
                                            ...
                                            System.err.println("Số lượng sản phẩm mà bạn muốn thêm phải là nguyên lớn hơn 0,vui lòng nhập lại");
                                        }
                                    }catch (NumberFormatException ex){
    ...
    public static void updateCatalogName() {
        ...
        do {
            try {
                int catalogIdFind = Integer.parseInt(sc.nextLine());
                if(catalogIdFind>0){
            ...
            do {
                try{
                    ...
                    if(priceChange>0){
                        ...
                        System.err.println("Giá của sản phẩm phải là kiểu số thực, có giá trị lớn hơn 0 ,vui lòng nhập lại");
                    }
                }catch (NumberFormatException ex){
                    System.err.println("Giá của sản phẩm phải là số ,vui lòng nhập lại");
                }
            }while (true);
        }
    ...
    public static void searchByProductName() {
        ...
        for (Product pr : listProduct) {
            if (pr.getProductName().toLowerCase().contains(findByProductName.toLowerCase())) {
                System.out.printf("%-20s%-20s%-20s%-20s%-30s%-40s\n", "Mã sản phẩm", "Tên sản phẩm", "Giá sản phẩm", "Tiêu đề sản phẩm", "Trạng thái sản phảm", "Tên danh mục thuộc về");
                pr.displayData();
