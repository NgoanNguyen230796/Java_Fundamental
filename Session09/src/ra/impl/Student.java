...
public class Student implements IStudent {
    ...
    @Override
    public void inputData(Scanner sc, Student[] arrStudent, int index) {
...
//>= MARK_PASS thì trạng thái là PASS ngược lại là FAIL
    ...
    public void displayData() {
        System.out.printf("%-15s%-15s%-10d%-17.2f%-15.2f%-20.2f%-25.2f%-20s%-20s%-20s\n", this.studentId,this.studentName,this.age,this.htmlScore,this.cssScore,this.javascriptScore,this.avgMark,convertSex(),this.classification,this.status);
    }
